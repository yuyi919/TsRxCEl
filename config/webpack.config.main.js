...
} = require("./utils/getOptimizationConfig");
...
// exports.shouldInlineRuntimeChunk = shouldInlineRuntimeChunk;
...
const cssFileChunkname = 'css/app.[contenthash:12].css';
...
module.exports = {
  ...
  plugins: [
    ...
    // webpack4-NOTE: ExtractTextPlugin => MiniCssExtractPlugin
    ...
    new MiniCssExtractPlugin({
      ...
      chunkFilename: cssFileChunkname // use contenthash *
    }),
